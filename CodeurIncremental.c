...
RCC->APB2ENR |= RCC_APB2ENR_IOPAEN; // pour enable le GPIO pour la connection avec la girouette (PA : 5,6,7)
RCC->APB1ENR |= RCC_APB1ENR_TIM3EN; // pour enable le timer 3	

LL_TIM_SetAutoReload(TIM3,0x05A0); //autoreload de 1440 (on compte 4 fois par cycle et on a 360 cycles par tour)

//Programmation selon la datasheet RM008
